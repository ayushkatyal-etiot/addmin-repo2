...
| Office Home / My Actions dashboard + basic Executive dashboard with drill-down | Multi-tenant Group/Platform-Operator hierarchy beyond single-org tenancy (Epic 0's Group layer) | Predictive maintenance / consumable replenishment (AI-based, future) |
